...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("clipboardhistory",{url:"/clipboardhistory",templateUrl:"templates/clipboardhistory.html"}).state("favourites",{url:"/favourites",templateUrl:"templates/favourites.html"})}]);
